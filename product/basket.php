...
?>
    <tr>
        ...
        <td><a href="clear2.php?id=<?=$pid;?>" class="btn btn-danger btn-sm"><i class="bi bi-trash-fill"></i> ลบ</a></td>
...
<a href="mainpage.php"   class="btn btn-outline-primary m-1"><i class="bi bi-skip-backward-fill"> กลับหน้าสินค้า</i></a>
...
<div class="modal fade" id="alertModal" tabindex="-1" aria-labelledby="alertModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-start"> <!-- เพิ่ม class text-start ที่นี่ -->
                <p style="margin: 0;">โปรดเลือกสินค้าก่อน</p> <!-- ใช้ <p> tag สำหรับข้อความ -->
            </div>
...
<a href="view_order.php" class="btn btn-outline-warning"><i class="bi bi-cart-check-fill"></i> รายละเอียดคำสั่งซื้อ</i></a></div>
</div>
<?php } else { ?>
	...
	<div style="text-align: right;">
<!-- ปุ่มสำหรับลบสินค้าทั้งหมด -->
<a href="#" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal">
    <i class="bi bi-trash-fill"></i> ลบสินค้าทั้งหมด
</a>

<!-- โมเดลสำหรับยืนยันการลบ -->
<div class="modal fade" id="deleteConfirmationModal" tabindex="-1" aria-labelledby="deleteConfirmationLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteConfirmationLabel">ยืนยันการลบ</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body text-start">
                <p>คุณแน่ใจหรือว่าต้องการลบสินค้าทั้งหมดจากตะกร้า?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">ปิด</button>
...
<script>
    document.getElementById('confirmDelete').addEventListener('click', function() {
        // ทำการลบสินค้าโดยการ redirect ไปยัง clear.php
        window.location.href = 'clear.php';
    });
</script>
<a href="mainpage.php" class="btn btn-outline-primary m-1"><i class="bi bi-skip-backward-fill"> กลับหน้าสินค้า</i></a>
<!-- ปุ่มสำหรับยืนยันการสั่งซื้อ -->
<a href="#" class="btn btn-outline-success m-1" data-bs-toggle="modal" data-bs-target="#orderConfirmationModal">
    <i class="bi bi-cart-check-fill"></i> ยืนยันการสั่งซื้อ
</a>

<!-- โมเดลสำหรับแสดงผลลัพธ์คำสั่งซื้อ -->
<div class="modal fade" id="orderConfirmationModal" tabindex="-1" aria-labelledby="orderConfirmationLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="orderConfirmationLabel">ยืนยันการสั่งซื้อ</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="window.location.href='record.php'"></button>
            </div>
            <div class="modal-body text-start">
                <p>คำสั่งซื้อของคุณได้ถูกยืนยันแล้ว!</p>
                <p>รายละเอียดคำสั่งซื้อ:</p>
                <ul>
                    <li>ชื่อลูกค้า: <span id="customerName">ชื่อของลูกค้า</span></li>
                    <li>ที่อยู่: <span id="customerAddress">ที่อยู่ของลูกค้า</span></li>
                    <li>หมายเลขโทรศัพท์: <span id="customerPhone">หมายเลขโทรศัพท์ของลูกค้า</span></li>
                    <li>ยอดรวม: <span id="orderTotal">ยอดรวมคำสั่งซื้อ</span></li>
                </ul>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="window.location.href='record.php'">ปิด</button>
            </div>
        </div>
    </div>
</div>
<a href="view_order.php" class="btn btn-outline-warning"><i class="bi bi-cart-check-fill"></i> รายละเอียดคำสั่งซื้อ</i></a>
	</div>
...
<style>
.modal-body {
    text-align: right; /* จัดข้อความทั้งหมดใน modal-body ให้ชิดขวา */
}
</style>

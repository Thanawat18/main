    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel">
      ...
      <div class="offcanvas-body">
        ...
        <ul class="navbar-nav d-flex justify-content-between w-100 align-items-center">
          ...
          <li class="nav-item me-4"><a class="nav-link fs-5" href="#">ติดต่อเรา</a></li>
          <!-- Search Bar -->
...
?>
    <tr>
        <td colspan="8" height="50" align="center">ไม่มีรายการสั่งซื้อ</td>
    </tr>
<?php } // end if ?>
</table>
	<?php
...
<?php } else { ?>
	<div style="text-align: right;">
<a href="clear.php" class="btn btn-outline-danger"><i class="bi bi-trash-fill"></i> ลบรายการสั่งซื้อทั้งหมด</a> 
<a href="mainpage.php" class="btn btn-outline-primary m-1"><i class="bi bi-skip-backward-fill"> กลับหน้าสินค้า</i></a>

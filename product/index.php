      ...
      <div class="offcanvas-body">
        ...
        <ul class="navbar-nav d-flex justify-content-center flex-grow-1 align-items-center">
          <li class="nav-item me-3">
			  <a class="nav-link fs-6" href="signadmin.php"><i class="bi bi-person-fill-lock fs-4"></i></a></li>
                    ...
                    <div class="col d-flex justify-content-center ">
                        <div class="card text-center" style="width: 22rem; height: 100%; ">
                            <img src="images/<?=$data['p_id'];?>.<?=$data['p_ext'];?>" 
                                 class="card-img-top" 
                                 onClick="window.location='detail2.php?id=<?= $data['p_id']; ?>';"
                            ...
                            <div class="card-body">
                                ...
                                <a href="basket2.php?id=<?= $data['p_id']; ?>" class="btn btn-outline-danger"><i class="bi bi-cart"></i> เพิ่มลงรถเข็น</a>
                            </div>
                        </div>
                    </div>
                    <?php } ?>

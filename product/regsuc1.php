...
<div class="modal modal-sheet position-static d-block bg-body-secondary p-4 py-md-5" tabindex="-1" role="dialog" id="modalSheet">
    ...
    <div class="modal-content rounded-4 shadow">
      <div class="modal-header border-bottom-0">
		...
		<button type="button" class="btn-close" onclick="window.location.href='index.php'" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body py-0">
        <p><?php echo isset($modalBody) ? $modalBody : ''; ?></p>
      </div>
      <div class="modal-footer flex-column align-items-stretch w-100 gap-2 pb-3 border-top-0">
        <button type="button" class="btn btn-lg btn-primary" onclick="window.location.href='sign-in.php'">Sign-in</button>
		<button type="button" class="btn btn-lg btn-secondary" onclick="window.location.href='index.php'" data-bs-dismiss="modal">Close</button>
      </div>
    </div>
  </div>
</div>	

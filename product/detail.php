...
<main class="form-signin w-100 m-100" style="margin-top: 100px;">
	...
	$sql = "SELECT * FROM `product` WHERE `p_id` ='{$_GET['id']}' "; //การสร้างตัวแปร id เพื่อเข้าดูรายละเอียด คือ detail.php?id=1 หมายเลข1 คือรหัสสินค้า p_id ใน Database
	...
	<section class="py-5">
		<div class="container px-4 px-lg-5 my-5">
			<div class="row gx-4 gx-lg-5 align-items-center">
				<div class="col-md-6">
					<img src="images/<?= $data['p_id']; ?>.<?= $data['p_ext']; ?>" width="100%">
				</div>
				...
				<div class="col-md-6">
					...
					<div class="d-flex justify-content-end">
						<a href="basket.php?id=<?=$data['p_id'];?>" class="btn btn-outline-danger m-2 flex-grow-0"><i class="bi bi-cart"></i> เพิ่มลงรถเข็น</a>
						<a href="mainpage.php" class="btn btn-outline-primary m-2 flex-grow-0">
							<i class="bi bi-skip-backward-fill"></i> กลับ
						</a>
					</div>
				</div>
			</div>
